...
export function SavedIdeas({ entries }: SavedIdeasProps) {
  ...
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden">
      <div className="px-4 sm:px-5 py-3 sm:py-4 border-b border-zinc-800 flex items-center gap-2">
        ...
        {savedIdeas.map((entry) => {
          ...
          return (
            <button
              ...
              className="w-full px-4 sm:px-5 py-3 sm:py-4 text-left hover:bg-zinc-800/50 transition-colors group"
            >
              <div className="flex items-start gap-3">
                ...
                <svg className="w-4 h-4 text-zinc-600 group-hover:text-amber-400 transition-colors flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
